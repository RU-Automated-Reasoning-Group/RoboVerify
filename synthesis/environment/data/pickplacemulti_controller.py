...
def get_pickmulti_control(obs, relative_grasp_position=(0., 0., -0.02), workspace_height=0.1, dist_atol=3e-2, other_atol=1e-3, gain=10, block_id=0, last_block=False):
    """
    Returns
    -------
    action : [float] * 4
