...
def get_pickmulti_control(obs, relative_grasp_position=(0., 0., -0.02), workspace_height=0.1, atol=1e-3, gain=10, block_id=0, last_block=False):
    """
    Returns
    -------
    action : [float] * 4
    ...
    if block_is_grasped(obs, relative_grasp_position, block_position, atol=atol) and (block_position[2] - place_position[2] - used_workspace_height) ** 2 < atol:
